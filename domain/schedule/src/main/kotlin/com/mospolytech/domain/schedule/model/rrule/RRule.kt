...
import com.mospolytech.domain.schedule.model.rrule.RRule.DateParser.parseRRuleInstant
import com.mospolytech.domain.schedule.model.rrule.RRule.DateParser.toRruleString
...
open class RRule() {
    ...
    object DateParser {
        fun parseRRuleInstant(date: String): Instant {
            val dateTime = java.time.LocalDateTime.parse(date, dateFormatter)
            return dateTime.toKotlinLocalDateTime().toInstant(TimeZone.UTC)
        }

        fun Instant.toRruleString(): String {
            return dateFormatter.format(this.toJavaInstant())
        }
